# BMI-Calculator
A simple Body Mass Index (BMI) Calculator built using HTML, CSS, and JavaScript. This web application allows users to calculate their BMI based on their height and weight, helping them understand their body health category.
